...
types = {
        'stress' : ['Let Go Of Stress', 'An easy meditation excercise to let go off stress and relax the brain and body.', '<iframe width="1120" height="630" src="https://www.youtube.com/embed/c1Ndym-IsQg?start=5&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'],
