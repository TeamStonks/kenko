...
types = {
        'stress' : ['Let Go Of Stress', 'An easy meditation excercise to let go off stress and relax the brain anf body.', '<iframe width="1120" height="630" src="https://www.youtube.com/embed/c1Ndym-IsQg?start=5&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'],
        ...
        'letting-go' : ['Letting Go of Effort', 'Sometimes putting in less effort is beneficial. This meditation excercise teaches you the art of letting go.','<iframe width="1120" height="630" src="https://www.youtube.com/embed/wyj8l9miy4w?&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'],
